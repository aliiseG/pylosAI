...
class AI:
    ...
    def minimax(self, board_empty, board_taken):
        ...
        #def minimax (self, board_empty, board_taken, maximizing):
            # def checkWin(self):
            # arrayNr=[]
            # global text_winner
            # for n in self.taken_spots:
            ...
            # if maximizing:
                    ...
                    #             #best_moves = 0
                    # elif best_moves[1] == 3:
                    #     board.updateState(Spot(401,506,14,0), True) #true nozīmē ka tas ir AI, kas taisa gājienu
